Compartilho com vocês esse post muito bacana feito pelo blog [Profissional de E-commerce](http://www.profissionaldeecommerce.com.br/manual-para-um-e-commerce-b2b-de-sucesso/). Fala sobre como tornar seu e-commerce B2B um sucesso. Espero que aproveitem a leitura e possam colocar em prática todas as dicas.

Manual para um E-commerce B2B de Sucesso. Um dos maiores desafios que os fabricantes e distribuidores enfrentam com suas operações de e-commerce B2B está em contratar a equipe certa. Empresas B2B precisam identificar papéis de trabalho necessários e, em seguida, contratar, treinar e gerenciar a equipe. Como a maioria das empresas B2B está começando do zero no e-commerce, isso pode ser difícil. Em muitos casos, **uma equipe despreparada atrasa ou impede o sucesso da operação. **
...
![imagem](http://www.romerorodrigues.com/wp-content/uploads/2014/04/e-commerce-b2b-staples.png)
...
[TRADUÇÃO DO TEXTO DO PRACTICAL E-COMMERCE, ESCRITO POR DALE TRAXLER](http://www.practicalecommerce.com/articles/65050-12-Key-Job-Roles-for-B-to-B-Ecommerce-Success)
